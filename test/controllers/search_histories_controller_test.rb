...
class SearchHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search_history" do
    assert_difference('SearchHistory.count') do
      post search_histories_url, params: { search_history: { search_term: @search_history.search_term } }
    end
  ...
  test "should update search_history" do
    patch search_history_url(@search_history), params: { search_history: { search_term: @search_history.search_term } }
